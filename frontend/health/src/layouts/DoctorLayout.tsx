...
// Navigation items will be defined inside component to access translations
...
export default function DoctorLayout() {
  ...
  const navItems: NavItem[] = [
    ...
    { name: "Manage Patients", path: "/doctor/patients", icon: Users },
    { name: "Case Management", path: "/doctor/cases", icon: FolderOpen },
    { name: "Archived Cases", path: "/doctor/cases/archived", icon: Archive },
    { name: "Pending Reviews", path: "/doctor/recommendations", icon: ClipboardList },
  ];
        ...
        <nav className="flex-1 px-4 py-6">
          <ul className="space-y-2">
            {navItems.map((item) => {
              ...
              // Use exact match for /doctor/cases to avoid highlighting when on archived
              const isActive =
                item.path === "/doctor/cases"
              ...
              <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-500">
                    {currentUser?.email || "doctor@healthcare.com"}
                  </p>
                </div>
                <button
